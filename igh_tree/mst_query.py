...
global max_lineage_num_unique_seqs
max_lineage_num_unique_seqs = 5000
...
def query(patient_uid, clustering_uid, num_workers, i_worker, outfile,
    ...
    subs = {"p": patient_uid, "c": clustering_uid, "w": work_group, "i": i_worker, "f": outfile, "m": max_lineage_num_unique_seqs}
