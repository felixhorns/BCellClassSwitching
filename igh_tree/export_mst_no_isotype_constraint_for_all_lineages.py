...
def main(argv):
    ...
    print "Done!!"
    print "export_mst_no_isotype_constraint_for_lineages elapsed time (wall clock):", time.time() - start_time_mst

def export_msts(infile, field_dict, msts_dir, output_dir):

    # Open and write headers into output files
    output_nodes = output_dir + "/mst_no_isotype_constraint.all_lineages.nodes.cytoscape"
    ...
    output_edges = output_dir + "/mst_no_isotype_constraint.all_lineages.edges.cytoscape"
