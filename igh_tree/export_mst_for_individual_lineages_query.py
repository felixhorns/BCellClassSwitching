...
def main(argv):
    ...
    outfile_query = wdir + "/export_mst_for_individual_lineages.query.temp." + str(i_worker)
    outfile_query_field_dict = wdir + "/export_mst_for_individual_lineages.query.field_dict.json.temp." + str(i_worker)
